        ...
        <tbody>
          ...
          <tr v-for="item in paginatedList" :key="item.ma_phieu" class="table-row">
            ...
            <td style="padding: 12px 15px; text-align: center; white-space: nowrap;">
              <button @click="downloadPDF(item.ma_phieu)" style="margin-right: 5px; cursor: pointer; border: none; background: none; font-size: 16px;" title="Xuất PDF"><Download size="16" /></button>
              <button v-if="hasRole([3, 5])" @click="openModal(item)" style="margin-right: 5px; cursor: pointer; border: none; background: none; font-size: 16px;" title="Sửa"><Pen size="16" /></button>
